...
INGREDIENS_URL = reverse('recipe:ingredient-list')
...
class PublicIngredientApiTests(TestCase):
    ...
    def test_login_required(self):
        ...
        res = self.client.get(INGREDIENS_URL)
...
class PrivateIngredientApiTest(TestCase):
    ...
    def test_create_ingredient_successful(self):
        ...
        payload = {'name': 'Chili'}
        self.client.post(INGREDIENS_URL, payload)
    ...
    def test_creat_ingredient_invalide(self):
        """Test creating new ingredient with invalid payload"""
        payload = {'name': ''}

        res = self.client.post(INGREDIENS_URL, payload)
